...
DROP POLICY IF EXISTS "Cards are viewable if collection is accessible" ON public.cards;
...
DROP POLICY IF EXISTS "Users can manage cards in their own collections" ON public.cards;
